...
export class ReservationMapper {
  static toDomain(raw: ReservationModel) {
    ...
    return Reservation.reconstruct(
      ...
      ReservationDateRange.fromValues(raw.arrival * 1000, raw.departure * 1000),
  ...
  static toPersistence(reservation: Reservation) {
    return {
      ...
      arrival: Math.floor(reservation.getDateRange().arrival / 1000),
      departure: Math.floor(reservation.getDateRange().departure / 1000),
